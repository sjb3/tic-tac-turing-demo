Guess there are version differences between my create-react-app and the instructor's
Hence, used the start-up code instead building up from bottom
and due to dependency version issue, react-router@3.0.2 is used
